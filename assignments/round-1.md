# Round 1 — Site Assignments / Tur 1 — Site Atamaları

## English

This is **copy 1** of the assignment rotation. Each round everyone gets 5–6 sites.
...
**Round 1** block in each site file, then tick the box here ([x]) and commit.
...
Bu, atama rotasyonunun **1. kopyasıdır**. Her tur herkese 5–6 site düşer.
...
dosyasında **Tur 1** bloğunu doldurun, bitirince buradaki kutucuğu işaretleyin
