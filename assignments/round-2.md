# Round 2 — Site Assignments / Tur 2 — Site Atamaları

## English

This is **copy 2** of the assignment rotation. Each round everyone gets 5–6 sites.
...
**Round 2** block in each site file, then tick the box here ([x]) and commit.
For the full rotation see ../site-assignments.md.

### Berkay — Group A (01–05)
...
Bu, atama rotasyonunun **2. kopyasıdır**. Her tur herkese 5–6 site düşer.
...
dosyasında **Tur 2** bloğunu doldurun, bitirince buradaki kutucuğu işaretleyin
