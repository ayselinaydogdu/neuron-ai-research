# Round 3 — Site Assignments / Tur 3 — Site Atamaları

## English

This is **copy 3** of the assignment rotation. Each round everyone gets 5–6 sites.
...
**Round 3** block in each site file, then tick the box here ([x]) and commit.
For the full rotation see ../site-assignments.md.

### Yasemin — Group A (01–05)
...
Bu, atama rotasyonunun **3. kopyasıdır**. Her tur herkese 5–6 site düşer.
...
dosyasında **Tur 3** bloğunu doldurun, bitirince buradaki kutucuğu işaretleyin
([x]) ve commit'leyin. Rotasyonun tamamı için ../site-assignments.md.

### Yasemin — Grup A (01–05)
